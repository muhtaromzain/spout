...
class SheetTest extends TestCase
{
    ...
    public function testWritesDefaultCellSizesIfSet()
    {
        ...
        $this->assertStringContainsString(' style:column-width="100pt"', $xmlContents, 'No default col width found in sheet');
        $this->assertStringContainsString(' style:row-height="20pt"', $xmlContents, 'No default row height found in sheet');
        $this->assertStringContainsString(' style:use-optimal-row-height="false', $xmlContents, 'No optimal row height override found in sheet');
    }
    ...
    public function testWritesColumnWidths()
    {
        ...
        $this->assertStringContainsString('<style:style style:family="table-column" style:name="co0">', $xmlContents, 'No matching custom col style definition found in sheet');
        $this->assertStringContainsString('<style:table-column-properties fo:break-before="auto" style:use-optimal-column-width="false" style:column-width="100pt"/>', $xmlContents, 'No matching table-column-properties found in sheet');
        $this->assertStringContainsString('table:style-name="co0"', $xmlContents, 'No matching table:style-name found in sheet');
        $this->assertStringContainsString('table:number-columns-repeated="1"', $xmlContents, 'No matching table:number-columns-repeated count found in sheet');
    }
    ...
    public function testWritesMultipleColumnWidths()
    {
        ...
        $this->assertStringContainsString('<style:table-column-properties fo:break-before="auto" style:use-optimal-column-width="false" style:column-width="100pt"/>', $xmlContents, 'No matching table-column-properties found in sheet');
        $this->assertStringContainsString('table:style-name="co0"', $xmlContents, 'No matching table:style-name found in sheet');
        $this->assertStringContainsString('table:number-columns-repeated="3"', $xmlContents, 'No matching table:number-columns-repeated count found in sheet');
    }
    ...
    public function testWritesMultipleColumnWidthsInRanges()
    {
        ...
        $this->assertStringContainsString('<style:style style:family="table-column" style:name="co0">', $xmlContents, 'No matching custom col style 0 definition found in sheet');
        $this->assertStringContainsString('<style:style style:family="table-column" style:name="co1">', $xmlContents, 'No matching custom col style 1 definition found in sheet');
        $this->assertStringContainsString('<style:style style:family="table-column" style:name="co2">', $xmlContents, 'No matching custom col style 2 definition found in sheet');
        $this->assertStringContainsString('<style:style style:family="table-column" style:name="co3">', $xmlContents, 'No matching custom col style 3 definition found in sheet');
        $this->assertStringContainsString('<style:style style:family="table-column" style:name="co4">', $xmlContents, 'No matching custom col style 4 definition found in sheet');
        $this->assertStringContainsString('<style:table-column-properties fo:break-before="auto" style:use-optimal-column-width="false" style:column-width="100pt"/>', $xmlContents, 'No matching table-column-properties found in sheet');
        $this->assertStringContainsString('<style:table-column-properties fo:break-before="auto" style:use-optimal-column-width="false" style:column-width="50pt"/>', $xmlContents, 'No matching table-column-properties found in sheet');
        $this->assertStringContainsString('<table:table-column table:default-cell-style-name=\'Default\' table:style-name="co0" table:number-columns-repeated="1"/><table:table-column table:default-cell-style-name=\'Default\' table:style-name="co1" table:number-columns-repeated="1"/><table:table-column table:default-cell-style-name=\'Default\' table:style-name="co2" table:number-columns-repeated="2"/><table:table-column table:default-cell-style-name=\'Default\' table:style-name="co3" table:number-columns-repeated="1"/><table:table-column table:default-cell-style-name=\'Default\' table:style-name="co4" table:number-columns-repeated="1"/>', $xmlContents, 'No matching table:number-columns-repeated count found in sheet');
    }
    ...
    public function testCanTakeColumnWidthsAsRange()
    {
        ...
        $this->assertStringContainsString('<style:style style:family="table-column" style:name="co0">', $xmlContents, 'No matching custom col style 0 definition found in sheet');
        $this->assertStringContainsString('style:column-width="150pt"/>', $xmlContents, 'No matching table-column-properties found in sheet');
        $this->assertStringContainsString('table:style-name="co0"', $xmlContents, 'No matching table:style-name found in sheet');
        $this->assertStringContainsString('table:number-columns-repeated="3"', $xmlContents, 'No matching table:number-columns-repeated count found in sheet');
    }
